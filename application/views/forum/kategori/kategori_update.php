		...
		<div id="content">
			...
			<div id="maincontent">
				...
				<div class="boxbig">
					...
					<h1 class="titlebig">Edit Kategori Forum</h1>

					<div class="boxbigcontent">
                    
                    <?php foreach($fields as $row): ?>
					
                    <form method="post" action="<?= base_url() ?>forum_registered/katsimpanedit"  id="frmcontact">
                    <input type="hidden" name="id_kategori" value="<?= $row->id_kategori; ?>" />
                    <input type="hidden" name="user" value="1" />
                    
                    <label style="margin-left:-15px;">Title</label><br /><br />

					<input type="text" name="txtjudul" id="txtjudul" class="required" size="80" value="<?= $row->nama_kategori; ?>"/> <span>*</span><br />
					                                                    
                    <label style="margin-left:-15px;">Deskripsi</label><br /><br />
					
                    <textarea name="editor" id="editor"><?= $row->deskripsi; ?></textarea><br />

					<div align="right">

						<button class="buttons buttons-orange" type="submit"><span class="disk"></span>Simpan</button>

						<a href="<?= base_url(); ?>forum_registered/kategori_list" class="buttons buttons-orange"><span class="cancel"></span>Batal</a>
