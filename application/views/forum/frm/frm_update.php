		...
		<div id="content">
			...
			<div id="maincontent">
				...
				<div class="boxbig">
					...
					<h1 class="titlebig">Edit Sub Kategori Forum</h1>

					<div class="boxbigcontent">
                    
                    <?php foreach($fields as $row): ?>
					
                    <form method="post" action="<?= base_url() ?>forum_registered/frmsimpanedit"  id="frmcontact">
                    <input type="hidden" name="id_subkategori" value="<?= $row->id_subkategori; ?>" />
                    <input type="hidden" name="user" value="1" />
                    
                    <label style="margin-left:-15px;">Kategori</label><br /><br />
                    
                    <select name="id_kategori" style="height:29px; width:90%;">

									<option value="" selected="selected"> -- Level User --&nbsp;&nbsp;</option>

									<?php foreach($kategori as $s): ?>

									<?php if($row->id_kategori==$s->id_kategori){ $style="selected"; }else{ $style=""; } ?>
					...
					<input type="text" name="txtjudul" id="txtjudul" class="required" size="80" value="<?= $row->nama_subkategori; ?>"/> <span>*</span><br />
					                                                    
                    <label style="margin-left:-15px;">Deskripsi</label><br /><br />
					
                    <textarea name="editor" id="editor"><?= $row->deskripsi_sub; ?></textarea><br />

					<div align="right">
						
						<button class="buttons buttons-orange" type="submit"><span class="disk"></span>Simpan</button>
                        <a href="<?= base_url(); ?>forum_registered/frm_list" class="buttons buttons-orange"><span class="cancel"></span>Batal</a>
