		...
		<div id="content">
			...
			<div id="maincontent">
				...
				<div class="boxbig">
					...
					<h1 class="titlebig">Tambah Sub Kategori Forum</h1>

					<div class="boxbigcontent">
					
                    <form method="post" action="<?= base_url() ?>forum_registered/simpanfrm"  id="frmcontact">
                    <input type="hidden" name="user" value="<?=$this->session->userdata('userid')?>" />
                    
                    <label style="margin-left:-15px;">Kategori</label><br /><br />
                    
                    <select style="height:29px; width:90%;" name="id_kategori">
