						...
						<ul id="listnews">
							<li><h2><a href="<?=base_url()?>index.php/berita/detail/<?=$m->id_berita?>"><?=$m->judul_berita?></a></h2>
								...
								<p style="font-size:12px">
									<!--<a href="<?=base_url()?>index.php/berita/detail/<?=$m->id_berita?>"><img src="<?=base_url()?>uploads/img/medium/<?=$m->gambar?>" align="left" style="margin:5px 5px 5px 5px; width:260px; height:140px;" /></a> -->
									<?=$m->deskripsi_singkat?></p>
