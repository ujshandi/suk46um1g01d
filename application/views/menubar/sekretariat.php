	...
	<?=$headmenu?>
		<div id="content">
			<div id="maincontent">
				...
				<h1 class="titlebig">Sekretariat</h1>
					<div class="boxbigcontent">
					<form action="<?=base_url()?>sekretariat/update" method="post"  id="frmcontact">
					<textarea name="sekretariat" id="editor1" rows="25"><?=$sekretariat?></textarea>
					<br />
					<div>
