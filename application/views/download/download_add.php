		...
		<div id="content">
			<div id="maincontent">
				...
				<h1 class="titlebig">Tambah Download</h1>
					...
					<form method="post" action="<?=base_url()?>download/simpan"  id="frmcontact" enctype="multipart/form-data">
					<div>
						...
						<textarea name="deskripsi" id="f2" style="margin-top:10px" cols="78" rows="5"></textarea> <span>*</span><br />
