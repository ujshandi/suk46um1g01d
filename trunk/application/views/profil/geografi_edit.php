				...
				<h1 class="titlebig">Geografi dan Demografi</h1>
					<div class="boxbigcontent">
						<div style="margin-top:-20px">
							<form action="<?=base_url()?>profil/updategeografi" method="post"  id="frmcontact">
							<h3>Geografi dan Demografi</h3>
							<textarea name="geografi" id="editor1" rows="25"><?=$geografi?></textarea>
							<br />
							<div>
