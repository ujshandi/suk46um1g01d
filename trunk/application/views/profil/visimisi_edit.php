				...
				<h1 class="titlebig">Visi dan Misi</h1>
					<div class="boxbigcontent">
						<div style="margin-top:-20px">
							<form action="<?=base_url()?>profil/updatevisimisi" method="post"  id="frmcontact">
							<h3>Visi</h3>
							<textarea name="visi" id="editor1" rows="12"><?=$visi?></textarea>
							<br />
							<h3>Misi</h3>
							<textarea name="misi" id="editor2" rows="12"><?=$misi?></textarea>
							<br />
							<div>
