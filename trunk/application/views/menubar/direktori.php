	...
	function dropdown(id)
	{
		...
		if(stat=="none"){
			...
			$('.sub').hide();
				...
				<h1 class="titlebig">Direktori <?=COMPANY_NAME?></h1>
					<div class="boxbigcontent">
					<form action="<?=base_url()?>direktori/update" method="post"  id="frmcontact">
					<textarea name="direktori" id="editor1" rows="25"><?=$data?></textarea>
					<br />
					<div>
