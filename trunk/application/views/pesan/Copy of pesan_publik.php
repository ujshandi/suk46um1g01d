...
#frmcontact label.error, #frmcontact input.submit { margin-left: 253px; }
...
<!--  -->
                ...
                <div id="tambah" >
				 ...
				 <input type="text" name="txtemailpengirim" id="txtemailpengirim" class="textboxcontact" size="80" /> <span>*</span><br />
				 
                 <label style="margin-left:-15px;">Isi</label><br /><br />
                 
                 <textarea name="editor" id="editor" >isi disini</textarea><br />
                
                 <div align="right">

						<a href="<?=base_url()?>pesan/publik" class="button" >Cancel</a>
