...
<head>
...

	{
...

		{
			...
			location.href='<?=base_url()?>pesan/hapus/'+id;
	...
	<?=$headmenu?>
		...
		<div id="content">
			...
			<div id="maincontent">
				...
				<h1 class="titlebig">Daftar Pesan Pengunjung</h1>
					...
					<tbody>
						...
						<tr>
							...
							<td><?=$row->tanggal;?></td>
                          <td><a href="<?=base_url()?>pesan/detail/<?=$row->id_pesan?>" title="Detail"><?=$row->pengirim?></a></td>
                            <td><?=$row->email_pengirim;?></td>
							<td><?= $row->status?></td>
							<td align="center" width="12%">
								
								<a href="javascript:hapus('<?=$row->id_pesan?>');" title="Hapus"><img src="<?=base_url()?>public/images/icon/delete.png" /></a>
