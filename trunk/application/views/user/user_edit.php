				...
				<div class="boxbigcontent">
					<form method="post" action="<?=base_url()?>user/simpanedit"  id="frmcontact">
						<div class="boxess2">
							...
							<input type="text" name="nama_asli" id="txtnama" class="textboxcontact" size="80" value="<?=$row->nama_asli?>" /> 
							<span class="mand">*</span>
							<br /><br />
							<label style="margin:-1px 0 0 0;">Username</label>
							<input type="text" name="username" id="txtusername" class="textboxcontact" size="80" value="<?=$row->username?>" /> 
							<span class="mand">*</span>
							<br /><br />
							<label style="margin:-1px 0 0 0;">Password</label>
							<input type="password" name="password" id="txtpassword" class="textboxcontact" size="80" value="<?=$row->password?>" />
							<span class="mand">*</span>
							<br /><br />
