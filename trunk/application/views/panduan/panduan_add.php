...
<head>
	...
	function simpan()
	{
		...
		var data3	= document.getElementById('f2').value;
...
<div id="container">
	<?=$headmenu?>
		<div id="content">
			<div id="maincontent">
				<div class="boxbig">
				<h1 class="titlebig">Tambah Panduan / Pedoman</h1>
					<div class="boxbigcontent">
					<div style="margin-top:-20px">
						<form method="post" action="<?=base_url()?>panduan/simpan"  id="frmcontact">
						...
						<textarea name="deskripsi" id="editor1" rows="18"></textarea>
						<br /><br />
						<div align="right">
