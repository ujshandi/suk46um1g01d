...
<div id="container">
	<?=$headmenu?>
		<div id="content">
			<div id="maincontent">
				<div class="boxbig">
				<h1 class="titlebig">Edit Panduan</h1>
					<div class="boxbigcontent">
					<div style="margin-top:-20px">
						<form method="post" action="<?=base_url()?>panduan/simpanedit"  id="frmcontact">
						<?php foreach($data as $row): ?>
						<input type="hidden" name="id" value="<?=$row->id_panduan?>" />
						...
						<textarea name="deskripsi" id="editor1" rows="18"><?=$row->deskripsi?></textarea>
						<br /><br />
						<div align="right">
                        <a href="javascript:simpan();" class="buttons buttons-orange"><span class="disk"></span>Simpan</a>
						<a href="<?=base_url()?>panduan/data" class="buttons buttons-orange"><span class="cancel"></span>Batal</a>
