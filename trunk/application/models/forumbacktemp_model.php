<?php
class forumbacktemp_model extends CI_Model
{
	...
	function setBg($menu,$submenu,$id)
	{
		...
		{
			if($submenu==$id){
				$bg = base_url().'images/icon/bl2.png';
			}else{
				$bg = base_url().'images/icon/bl.png';
			}
		}
		else
		{
			if($menu==$id){
				...
				$bg = base_url().'images/icon/aturan.png';
			}
		}
		return $bg;
	}
				...
				$menu.='<h3 class="titlenav">Main Menu</h3>';
					...
					$menu.='<div class="boxnavcontent">';
						$menu.='<ul class="menunav">';
							...
							$menu.='<img src="'.$this->setBg("1","0",$id).'" align="left"/>Menubar</a></li>';
								$menu.='<ul class="sub" id="menubar" style="'.$style1.'">';
									$menu.='<li class="submenu"><a href="'.base_url().'direktori/edit">';
										$menu.='<img src="'.$this->setBg("1","1.1",$id).'" align="left"/>Direktori '.COMPANY_NAME;
									$menu.='</a></li>';
							...
							$menu.='</a></li>';
							$menu.='<li class="last"><a href="'.base_url().'user">';
