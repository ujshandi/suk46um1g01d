...
<div id="container">
	<?=$headmenu?>
		<div id="content">
			<div id="maincontent">
				<div class="boxbig">
				<h1 class="titlebig">Edit Agenda</h1>
					<div class="boxbigcontent">
					<?php foreach($agenda as $row): ?>
					<form method="post" action="<?=base_url()?>agenda/simpanedit"  id="frmcontact" enctype="multipart/form-data">
					<input type="hidden" name="id" value="<?=$row->id_agenda?>" />
					<input type="hidden" name="author" value="<?=$row->author?>" />
					<div>
						<label style="margin-left:-15px;">Tgl</label>
						<input type="text" name="tgl" id="f1" class="textboxcontact" size="15" value="<?=$row->tgl?>" /> <span>*</span><br />
						<label style="margin-left:-15px;">Deskripsi Kegiatan</label>
						<textarea name="kegiatan" id="f2" style="margin-top:10px" cols="78" rows="5"><?=$row->kegiatan?></textarea> <span>*</span><br /><br />
						<div align="right">
