...
<div id="container">
	<?=$headmenu?>
		<div id="content">
			<div id="maincontent">
				<div class="boxbig">
				<h1 class="titlebig">Tambah Data dan Statistik</h1>
					<div class="boxbigcontent">
					<form method="post" action="<?=base_url()?>statistik/simpan"  id="frmcontact" enctype="multipart/form-data">
					<div>
						<label style="margin-left:-15px;">Nama Kategori</label>
						<input type="text" name="kategori" id="f1" class="textboxcontact" size="70" /> <span>*</span><br />
