...
<head>
	...
	function hapus(id)
	{
		...
		if(confir==true)
		{
			location.href='<?=base_url()?>statistik/hapus/'+id;
		}
	}
	</script>
		...
		<div id="content">
			<div id="maincontent">
				...
				<h1 class="titlebig">Data dan Statistik</h1>
					...
					<a href="<?=base_url()?>statistik/add" class="button" >Tambah</a>
					<div align="left" style="margin-top:-13px;">
					<form method="post" action="<?=base_url()?>statistik/search2">
					...
					<tbody>
						...
						<tr>
							...
							<td><?=$row->kategori?></td>
							<td>
								<a href="<?=base_url()?>statistik/edit/<?=$row->id_statistik?>" title="Edit"><img src="<?=base_url()?>public/images/icon/edit.png" /></a>
								<a href="javascript:hapus('<?=$row->id_statistik?>');" title="Hapus"><img src="<?=base_url()?>public/images/icon/delete.png" /></a>
							</td>
						</tr>
						<?php endforeach;?>
					</tbody>
