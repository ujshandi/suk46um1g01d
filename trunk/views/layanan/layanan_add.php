...
<div id="container">
	<?=$headmenu?>
		<div id="content">
			<div id="maincontent">
				<div class="boxbig">
				<h1 class="titlebig">Tambah layanan <?=$kategori?></h1>
					<div class="boxbigcontent">
					<div style="margin-top:-20px">
					<form method="post" action="<?=base_url()?>layanan/simpan"  id="frmcontact">
					<input type="hidden" name="author" value="<?=$this->session->userdata('userid')?>" />
					<input type="hidden" name="kategori" value="<?=$tipe?>" />
					
						<label style="margin-left:-15px;">Judul Artikel</label><br />
						<input type="text" name="judul" id="f1" class="textboxcontact" size="110" /> <span>*</span><br />
						<label style="margin-left:-15px;">Deskripsi Artikel</label><br /><br />
						<textarea name="deskripsi" id="editor1" rows="25"></textarea>
						<br /><br />
