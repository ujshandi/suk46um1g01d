...
<div id="container">
	<?=$headmenu?>
		<div id="content">
			<div id="maincontent">
				<div class="boxbig">
				<h1 class="titlebig">Home</h1>
					<div class="boxbigcontent">
					<h3 align="center">selamat Datang, di halaman Member website Badan Pengembangan Sumber Daya Manusia Pendidik Dan Penjaminan Mutu Pendidikan </h3> 
					</div>
